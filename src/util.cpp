...
const char * const BITCOIN_CONF_FILENAME = "friccoin.conf";
const char * const BITCOIN_PID_FILENAME = "friccoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Friccoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Friccoin";
#else
    // Unix
    return pathRet / ".friccoin";
#endif
#endif
}
