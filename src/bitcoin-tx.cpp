...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s friccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  friccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded friccoin transaction") + "\n" +
              "  friccoin-tx [options] -create [commands]   " + _("Create hex-encoded friccoin transaction") + "\n" +
              "\n";
