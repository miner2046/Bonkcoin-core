 ...
 *
 *  Friccoin:    Increment mempool limits and accept RBF in steps of 0.0001 FRC
...
/**
 * Friccoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Friccoin: Default hard dust limit that is evaluated when considering whether
