 ...
 *
 *  Bonkcoin:    Increment mempool limits and accept RBF in steps of 0.0001 BONC
...
/**
 * Bonkcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Bonkcoin: Default hard dust limit that is evaluated when considering whether
