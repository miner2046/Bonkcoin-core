...
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/friccoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/friccoin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/friccoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/friccoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/friccoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/friccoin256.png %{buildroot}%{_datadir}/pixmaps/friccoin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/friccoin256.png %{buildroot}%{_datadir}/pixmaps/friccoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/friccoin256.png %{buildroot}%{_datadir}/pixmaps/friccoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/friccoin256.png %{buildroot}%{_datadir}/pixmaps/friccoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/friccoin256.png %{buildroot}%{_datadir}/pixmaps/friccoin256.xpm
...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15614
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 15614
