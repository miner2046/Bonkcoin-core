...
* [GitHubディスカッション](https://github.com/Bonkcoin/Bonkcoin-core/discussions)は、Bonkcoin Coreソフトウェアの開発、基礎となるプロトコル、およびFRC資産に関連する計画されたおよび計画されていない機能について議論するために使用されます。
